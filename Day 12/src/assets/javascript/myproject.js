    ...
    document.getElementById("contents").innerHTML += `
        <div class="blog-list-item">
                    ...
                    <div class="icon-technology">
                        ${(dataBlog[index].checkbox1 ? `<img src="/assets/image-repository/node-js.svg" class="show" alt="Node JS">` : `<img src="/assets/image-repository/node-js.svg" alt="/Node Js">`)}
                        ${(dataBlog[index].checkbox2 ? `<img src="/assets/image-repository/react.svg" class="show" alt="React JS">` : `<img src="/assets/image-repository/react.svg" alt="React JS">`)}
                        ${(dataBlog[index].checkbox3 ? `<img src="/assets/image-repository/next js.svg" class="show" alt="Next Js">` : `<img src="/assets/image-repository/next js.svg" alt="Next Js">`)}
                        ${(dataBlog[index].checkbox4 ? `<img src="/assets/image-repository/vuejs.svg" class="show" alt="Vue JS">` : `<img src="/assets/image-repository/vuejs.svg" alt="Vue Js">`)}
                    </div>
                    <div class="btn-group">
